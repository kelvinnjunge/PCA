...
```{r}
itemFrequencyPlot(supermarket,topN=10,type="absolute",col=brewer.pal(8,'Pastel2'), main="Absolute Item Frequency Plot")
itemFrequencyPlot(supermarket,topN=10,type="relative",col=brewer.pal(8,'Pastel2'),main="Relative Item Frequency Plot")
```
...
```{r}
bacon.association.rules <- apriori(supermarket, parameter = list(supp=0.001, conf=0.8), appearance = list(default="lhs", rhs= "bacon"))
```
